...
function Header(){
	...
	$this->Image('http://booking.myhost.com/docs/pdf/class/img/logo.jpg',20,10,50,0,'JPG');
    $this->Image('http://booking.myhost.com/docs/pdf/class/img/kimirina-fondo.jpg',19,130,180,0,'JPG');
    $this->Ln(4);
    $this->Cell(300,-10,utf8_decode("CORPORACIÓN KIMIRINA"),0,0,'C');
    $this->SetFont('Courier','',7);
    $this->Ln(4);
    $this->Cell(300,-10,utf8_decode("Andrés Xaura N24-176 e/ Mariscal Foch y Lizardo García"),0,0,'C');
    $this->Ln(4);
    $this->Cell(300,-10,utf8_decode("Quito - Ecuador"),0,0,'C');
    $this->Ln(4);
    $this->Cell(300,-10,utf8_decode("Teléfono: (02) 2500-969"),0,0,'C');
    $this->Ln(4);
    $this->Cell(300,-10,utf8_decode("E-mail: kimirina@kimirina.org"),0,0,'C');
...
function Footer(){
    ...
    /*$this->Cell(23);
    $this->MultiCell(80,3,utf8_decode("Para verificar la autenticidad de este documento por favor ingresar a la página web del código QR, Id: XXXX, Factor: XXXX"),0,'L',0);
    $this->Cell(100,20,utf8_decode("La interpretación de resultados es exclusivo del médico"),0,1,'L',0);
    $this->SetY(-18);
    $this->Cell(100,0,utf8_decode("(*) Los valores de referencia de este informe están de acuerdo a la edad y sexo del paciente"),0,2,'L',0);
    $this->SetY(-13);
    $this->SetFont('Arial','I',8);
    $this->Image("http://laboratorio.kimirina.org/laboratorio/pdf/qr/image.php?msg=$_GET[docId]", 15, 260, 15, 15, "png");
    $this->Image('http://laboratorio.kimirina.org/laboratorio/pdf/class/img/lili.jpg',145,250,45,0,'JPG');
