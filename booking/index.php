                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">Servicio de Proctología</h4>
                                        <h5 class="text-danger">Presencial</h5>
                                        <p class="card-text">Servicio disponible en la ciudad de Quito de forma presencial</p>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="../assets/images/gallery/1.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Salud Sexual y Reproductiva</h4>
                                        <h5 class="text-danger">Presencial</h5>
                                        <p class="card-text">Servicio disponible en la ciudad de Quito y Guayaquil de forma presencial</p>
                                        <a href="#" class="btn btn-primary">Reservar</a>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="../assets/images/gallery/1.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Pruebas Rápidas de VIH e ITS</h4>
                                        <h5 class="text-danger">Presencial</h5>
                                        <p class="card-text">Agenda tu cita para realizarte una prueba que detecta el VIH y las ITS más comunes</p>
                                        <a href="#" class="btn btn-primary">Reservar</a>
                                    </div>
                                </div>
                            </div><!-- end col -->
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="../assets/images/gallery/1.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <h4 class="card-title">Atención de Telemedicina</h4>
                                        <h5 class="text-danger">Virtual</h5>
                                        <p class="card-text">Servicio disponible para atenciones específicas de: PrEP, PEP</p>
                                        <a href="#" class="btn btn-primary">Reservar</a>
                                    </div>
                                </div>
                            </div><!-- end col -->
