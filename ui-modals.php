<?php require_once('Connections/simon.php'); ?>
<?php
...
$conn_simon = new KT_connection($simon, $database_simon);
...
$loginTransaction = new tNG_login($conn_simon);
...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Modals | Adminto - Responsive Admin Dashboard Template</title>
